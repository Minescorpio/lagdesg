        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-6">
                        <div class="relative">
                            <input type="search" wire:model.live="search" placeholder="Rechercher des catégories..." class="search-input" />
                                    ...
                                    <tr class="hover:bg-[#2E324A] transition-colors duration-200">
                                        ...
                                        <td class="text-right">
                                            <div class="flex items-center justify-end space-x-2">
                                                ...
                                                <button wire:click="confirmDelete({{ $category->id }})" class="btn-danger btn-sm">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
